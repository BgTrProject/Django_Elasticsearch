...
class evrensel:
    ...
    def get_link(self,i):
        ...
        for a in soup.find_all('a', href=True):
            ...
            say = count2 - 93
            say = say + 50
            if str(link).strip().startswith("https://www.evrensel.net/dail") or str(link).strip().startswith("https://abone.evrensel.ne"):
                pass
            elif (count > 49 and count < say):  # 58 haber 49 dan başlıyo
                print(link)
