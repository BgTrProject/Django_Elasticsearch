        ...
        for i in list2:
            ...
            for j in h:
                try:
                    ...
                    elif lnk.startswith("/news") or lnk.startswith("/money") or lnk.startswith(
                            "/health") or lnk.startswith("/debate") or lnk.startswith("/tvshowbiz") or lnk.startswith(
                            "/wires") or lnk.startswith("/sport"):
...
# url="https://www.dailymail.co.uk/home/sitemaparchive/day_20201010.html"
# html = requests.get(url).content
# # # date=url[37:]
# soup = BeautifulSoup(html, "html.parser")
# # list = soup.find_all("div", {"class": "col-12 col-lg mw0"})
...
# from datetime import datetime, timedelta
#
# url="https://www.dailymail.co.uk/tvshowbiz/article-8827409/Amanda-Kloots-puts-toned-figure-display-leotard-ahead-dance-class-alongside-son-Elvis.html"
#
# html = requests.get(url).content
#         # # date=url[37:]
# soup = BeautifulSoup(html, "html.parser")
