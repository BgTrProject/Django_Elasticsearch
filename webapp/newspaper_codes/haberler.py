...
class haberler:
 ...
 # https://www.haberler.com/arsiv/02-01-2017/haberler/s1/
    ...
    def get_link(self,url):
        ...
        with open(self.link_filname, "w", encoding="utf-8") as file:
            for i in page_news_links:
                file.write(i + "\n")
        # url="https://www.haberler.com/3-sayfa/su-altinda-kalan-guverteden-oksijen-tuplu-nefes-13658728-haberi/"
    def creator(self,url):
        ...
        # print(title)
        try:
            date = soup.find("time", {"class": "hbptTagDate hbptDate"}).getText()
            date = date[:-5]
        except:
            date="None"
        # print(date)
