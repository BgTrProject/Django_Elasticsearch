...
class guardian:
    ...
    def dateCreator(self,d1,d2):
        ...
        print(dates)
        if self.categ=="all":
            self.categ="world,science,technology,culture,news,business"
        else:
            pass
        categ2=self.categ.split(',')
        for k in categ2:
            link = '{}{}'.format("https://www.theguardian.com/",k)
        ...
        try:
            ...
            for i in links[:-2]:
                ...
                if (counter % 2 == 0):
                    ...
                    link=i.get("href")
                    if str(link).strip().startswith("https://www.theguardian.com/world/video"):
                        pass
                    else:
                        say += 1
